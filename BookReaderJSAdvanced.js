...
var options = {
  ...
  getPageURI: function(index, reduce, rotate) {
      ...
      var url = 'bookimages/sivaji/'+leafStr.replace(re, imgStr) + '.jpg';
      return url;
  },
  ...
  bookUrl: 'https://abeedworks.github.io/books/',
  bookUrlText: 'Back to Demos',
  bookUrlTitle: 'This is the book URL title',
  // thumbnail is optional, but it is used in the info dialog
  thumbnail: 'bookimages/sivaji/page001.jpg',
  ...
  imagesBaseURL: 'bookimages/sivaji/',
